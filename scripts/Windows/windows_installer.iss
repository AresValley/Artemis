...
SetupIconFile=..\..\data\images\installer_icon.ico
...
[Files]
Source: "..\..\artemis.dist\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\artemis.dist\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
